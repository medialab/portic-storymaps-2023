...
def nest_portic_pointcall_deprecated(pointcall):
  """
...
def nest_portic_pointcall(pointcall):
  """
  FONCTION DEPRECIEE : CERTAINS CHAMPS DES DONNÉES NAVIGO ONT ÉTÉ MODIFIÉS SUR L'API
...
def combine_commodity_purposes(pointcall):
  ...
  for suffix in suffixes:
    ...
    if commodity_purpose in pointcall and pointcall[commodity_purpose] is not None:
      ...
      pointcall["commodity_purposes"].append(purpose)
